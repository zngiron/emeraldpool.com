...
Full-page captures at 1440 and 390, regenerated by `python3 seed/shots.py`.
...
| About | Journal |
|---|---|
| ![About, desktop](screenshots/about-desktop.png) | ![Journal, desktop](screenshots/journal-desktop.png) |
...
Mobile captures for every page in the table are in `docs/screenshots/*-mobile.png`.

Three checks run against the seeded site and all three are green:

```sh
python3 seed/crawl.py    # every internal link and image: 0 broken, 0 "#" placeholders
python3 seed/axe.py      # axe-core colour-contrast, 14 pages x 2 widths: 0 violations
python3 seed/shots.py    # the screenshot set above
```
...
Page weight on the home page, which is the heaviest: **33 KB of CSS and 31 KB of JavaScript over
the wire**, against budgets of 200 KB and 40 KB.
